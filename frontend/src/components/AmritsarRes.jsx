...
import { AmritsarCollection, ResInAmritsar } from '../assets/Asserts'
    ...
    <>
      <div className='bg-[#f8f8f8] h-[900px]'>
              ...
              <div className='flex mx-60 pt-10 pb-5'>
                ...
                <div className='font-light text-red-500 ms-50'>All collections in Amritsar</div>
              </div>
                 <div className='grid grid-cols-4 mx-30'>
                          {
                            AmritsarCollection.map((p)=>{
                              return(
                                <div className=''>
                ...
                {/* <div className='grid grid-cols-4 mx-30 mt-80'>
                  ...
                  <div className='text-3xl font-semibold mx-35 mt-20'>Restaurants in Amritsar</div>
                                    <div className='grid grid-cols-3 mx-30 my-10'>
                                      {
                                        ResInAmritsar.map((r)=>{
                                          return(
                                            <div className='me-10 my-5 bg-gray-50 p-3'>
                                              <div><img src={r.image} alt="" className='rounded-sm h-[280px] w-[300px]'/></div>
