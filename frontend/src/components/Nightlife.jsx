...
import { Collectionsone, collectionstwo, NightlifeCollection } from '../assets/Asserts'
      ...
      <div className='bg-[#f8f8f8] h-[900px]'>
        ...
        <div>
            <ul className='flex mt-80 mx-40'>
              ...
              <li className='border p-2 rounded-sm me-5'>Pubs & Bars</li>
            </ul>
        </div>
        <div className='mt-20 mx-40'>
            <img src="https://b.zmtcdn.com/data/o2_assets/e067a1cf0d3fe27b366402b98b994e9f1716296909.png" alt="" />
        </div>
        <div className='mx-20 py-10 text-3xl font-semibold'>Nightlife: Night clubs, pubs and bar in Ahmedabad</div>
        <div className='grid grid-cols-3 ms-20'>
          {
            NightlifeCollection.map((p)=>{
              return(
                <div className='mx-3'>
                  <div><img src={p.image} alt="" className='rounded-sm w-[400px] h-[300px] '/></div>
                  <div className='text-sm py-1'>{p.name}</div>
                  <div className='text-sm '>{p.food}</div>
                  <div className='text-sm py-1'>{p.location}</div>
        ...
        <div className='ps-150 mt-20 mb-30'>
        ...
        <div className='mx-60'>
          <div className='text-3xl '>Explore options near me</div>
          <ul className='mt-10'>
            <li className='border border-gray-300 rounded-sm p-3 text-xl'>Popular cuisines near me</li>
            <li className='border border-gray-300 rounded-sm p-3 text-xl my-5'>Popular restaurant types near me</li>
            <li className='border border-gray-300 rounded-sm p-3 text-xl'>Top restaurant chains</li>
            <li className='border border-gray-300 rounded-sm p-3 text-xl my-5'>Cities we deliver to</li>
            <li className='border border-gray-300 rounded-sm p-3 text-xl'>Popular Dishes Near Me</li>
            <li className='border border-gray-300 rounded-sm p-3 text-xl my-5'>Discover More Fun</li>
          </ul>
        </div>
