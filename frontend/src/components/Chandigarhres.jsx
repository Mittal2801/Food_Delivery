...
import { ChandigarhCollection, ResInAhmedabad, ResInChandigarh } from '../assets/Asserts'
    ...
    <>
      <div className='bg-[#f8f8f8] h-[900px]'>
              ...
              <div className='flex mx-60 pt-10 pb-5'>
                ...
                <div className='font-light text-red-500 ms-50'>All collections in Chandigarh</div>
              </div>
                 <div className='grid grid-cols-4 mx-30'>
                          {
                            ChandigarhCollection.map((p)=>{
                              return(
                                <div className=''>
                ...
                {/* <div className='grid grid-cols-4 mx-30 mt-80'>
                  ...
                  <div className='text-3xl font-semibold mx-35 mt-20'>Restaurants in Chandigarh</div>
                                    <div className='grid grid-cols-3 mx-30 my-10'>
                                      {
                                        ResInChandigarh.map((r)=>{
                                          return(
