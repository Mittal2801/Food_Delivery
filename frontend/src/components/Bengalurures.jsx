...
import { BengaluruCollection, ResInBengaluru } from '../assets/Asserts'
    ...
    <>
      <div className='bg-[#f8f8f8] h-[900px]'>
              ...
              <div className='flex mx-60 pt-10 pb-5'>
                ...
                <div className='font-light text-red-500 ms-50'>All collections in Bengaluru</div>
              </div>
                 <div className='grid grid-cols-4 mx-30'>
                          {
                            BengaluruCollection.map((p)=>{
                              return(
                                <div className=''>
                ...
                {/* <div className='grid grid-cols-4 mx-30 mt-80'>
                  ...
                  <div className='text-3xl font-semibold mx-35 my-10'>Restaurants in Bengaluru</div>
                  <div className='grid grid-cols-3 mx-30'>
                    {
                        ResInBengaluru.map((r)=>{
                        return(
